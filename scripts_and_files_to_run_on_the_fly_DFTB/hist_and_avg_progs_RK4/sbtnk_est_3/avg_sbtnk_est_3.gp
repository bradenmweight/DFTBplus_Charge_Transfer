...
set output "norm_chrg_pop_sbtnk_est_3.png"
...
set xlabel "Time (ps)"
set ylabel "Charge Population (Est. 3)"

set style line 1 lt -1 lw 0.8
set style line 2 lt -1 lw 2.0 lc rgbcolor "#16A085"
set style line 3 lt -1 lw 2.0 lc rgbcolor "blue"

plot 'norm_sbtnk_est_3.txt' u ($1/1000):2 w l lw 5 t 'H2PC1',\
     'norm_sbtnk_est_3.txt' u ($1/1000):3 w l lw 5 t 'H2PC2',\
     'norm_sbtnk_est_3.txt' u ($1/1000):4 w l lw 5 t 'C60',\
     'norm_sbtnk_est_3.txt' u ($1/1000):5 w l lw 5 t 'tot'
